...
@Component(value = "beanByContent")
public class BeanByContent implements InitializingBean, DisposableBean {

    private final static String BEAN_NAME = "BeanByContent";
